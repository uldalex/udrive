    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        function getTimeHTML() {
            return '<div>' +
                ...
                '</div>' +
                '<div class="hour">' +
                '<label>' + translate('Hour') + ': <input type="range" style="width: 100%; --value:10; --min:0; --max:24;" class="hour-range styled-slider slider-progress" name="hour" min="0" max="23"></label>' +
                '</div>' +
                '<div class="minute">' +
                '<label>' + translate('Minute') + ': <input type="range" style="width: 100%; --value:2; --min:0; --max:60;" class="minute-range styled-slider slider-progress" name="minute" min="0" max="59"></label>' +
                '</div>';
        }
        ...
        function createDom() {
            ...
            html += '<div class="footer"><div class="dropdown-menu__footer" ><a href="#"  class="date-destroy btn btn--grey" aria-label="Сбросить">Сбросить</a><a href="#" class="btn btn--yellow" aria-label="Удалить">Удалить</a></div>';
